...
\begin{minipage}{\columnwidth}
  ...
  \begin{center}
    ...
    D\left(-\frac{\mathbf p_{RO}}{t}, \frac{r_{RO}}{t}\right).
    $
  \end{center}
  \vspace{-18pt}
...
\begin{minipage}{\columnwidth}
  ...
  \begin{center}
    $
    \bigtriangleup U = \sum \frac{\partial^2 U}{\partial q_i^2}.
    $
  \end{center}
\end{minipage}
...
\begin{minipage}{\columnwidth}
  ...
  \vmspace
  \begin{center}
    $f(N) = \underbrace{g(N)}_{\substack{\text{cost} \\
    \text{from start}}}
...
\begin{minipage}{\columnwidth}
  \textit{Examples:}\\
  1) \textbf{Breadth-first search}: FIFO queue, solution optimal for uniform edge
  costs, complexity: $\mathcal O (|N| + |E|)$.
...
\begin{minipage}{\columnwidth}
  ...
  \begin{compactitem}
  \item \textit{Push()}: Insert new node $N$ at end of heap. While $N <
